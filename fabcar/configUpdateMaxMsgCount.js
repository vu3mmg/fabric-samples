...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
	...
	updated_config_json.channel_group.groups.Orderer.values.BatchSize.version =  "" + (parseInt(updated_config_json.channel_group.groups.Orderer.values.BatchSize.version) + 1);
	updated_config_json.channel_group.groups.Orderer.version =  "" + (parseInt(updated_config_json.channel_group.groups.Orderer.version) + 1);
        console.log(updated_config_json.channel_group.groups.Orderer.version);

	// UPDATE ORG2MSP
	//updated_config_json.channel_group.groups.Consortiums.groups.SampleConsortium.groups.Org2MSP = updated_config_json.channel_group.groups.Consortiums.groups.SampleConsortium.groups.Org1MSP;
	//updated_config_json.channel_group.groups.Consortiums.groups.SampleConsortium.groups.version =  "" + (parseInt(updated_config_json.channel_group.groups.Consortiums.groups.SampleConsortium.groups.version) + 1);

        console.log(updated_config_json);
